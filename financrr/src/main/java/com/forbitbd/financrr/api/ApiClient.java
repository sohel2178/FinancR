...
public interface ApiClient {
    ...
    @POST("/api/projects/{project_id}/transactions")
    @Multipart
    ...
    @PUT("/api/projects/{project_id}/transactions/{transaction_id}")
    @Multipart
    ...
    @DELETE("/api/projects/{project_id}/transactions/{transaction_id}")
